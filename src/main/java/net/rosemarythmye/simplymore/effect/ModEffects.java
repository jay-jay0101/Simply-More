...
public class ModEffects {
    ...
    public static final StatusEffect PETRIFIED = registerEffect("petrified",new Solidify(StatusEffectCategory.HARMFUL,8948877).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED,"28908fac-dfb9-4cb7-b4e1-e4c55a661730",-99, EntityAttributeModifier.Operation.ADDITION));
