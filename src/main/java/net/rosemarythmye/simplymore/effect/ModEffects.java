...
public class ModEffects {
    ...
    public static final StatusEffect STUNNED = registerEffect("stunned",new Solidify(StatusEffectCategory.HARMFUL,8948877).addAttributeModifier(EntityAttributes.GENERIC_ARMOR,"224da8a4-a4bd-438b-ac8c-076b56aafdaf",10, EntityAttributeModifier.Operation.ADDITION).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED,"28908fac-dfb9-4cb7-b4e1-e4c55a661730",-99, EntityAttributeModifier.Operation.ADDITION).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE,"6c4be639-f6e6-40ce-a1b7-6374f17d5d85",-9999, EntityAttributeModifier.Operation.ADDITION));
    public static final StatusEffect STUNNED_MOXIE = registerEffect("stunned_moxie",new Solidify(StatusEffectCategory.HARMFUL,8948877).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_SPEED,"68a1d2b7-5914-46d5-a743-2f21ff21478b",-99, EntityAttributeModifier.Operation.ADDITION).addAttributeModifier(EntityAttributes.GENERIC_ATTACK_DAMAGE,"574bf225-f847-4666-a523-5cbd3abd2291",-9999, EntityAttributeModifier.Operation.ADDITION));
    ...
    public static final StatusEffect RADIANT_MARK = registerEffect("radiant_mark",new RadiantEffect(StatusEffectCategory.HARMFUL,0));
    public static final StatusEffect FORESEEN = registerEffect("soul_lock",new SoulForesight(StatusEffectCategory.HARMFUL,0));
    public static final StatusEffect ARMOUR_CRUNCH = registerEffect("armor_crunch",new ModStatusEffect(StatusEffectCategory.HARMFUL,9849600)).addAttributeModifier(EntityAttributes.GENERIC_ARMOR,"8de2ce50-1726-4da1-bb87-fb8a111ee116",-2, EntityAttributeModifier.Operation.ADDITION);
