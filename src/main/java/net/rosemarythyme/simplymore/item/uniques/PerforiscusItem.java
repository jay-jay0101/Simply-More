...
public class PerforiscusItem extends SimplyMoreUniqueSwordItem {
    ...
    public boolean postHit(ItemStack stack, LivingEntity target, LivingEntity attacker) {
        ...
        int amplifier = attacker.hasStatusEffect(ModEffectsRegistry.BLOOM) ?
                attacker.getStatusEffect(ModEffectsRegistry.BLOOM).getAmplifier() +1 : 0;
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        ...
        try {
            amplifier = user.getStatusEffect(ModEffectsRegistry.BLOOM).getAmplifier();
        ...
        if (amplifier >= 7) {
            ...
            StatusEffectInstance effect = user.getStatusEffect(ModEffectsRegistry.BLOOM);
            user.removeStatusEffect(ModEffectsRegistry.BLOOM);
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        ...
        tooltip.add(Text.translatable("item.simplymore.perforiscus.tooltip7").setStyle(textStyle));
