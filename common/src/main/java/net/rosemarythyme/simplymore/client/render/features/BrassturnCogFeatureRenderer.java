...
public class BrassturnCogFeatureRenderer {
    ...
    public static void render(ClientWorld world, MatrixStack stack, float delta, VertexConsumerProvider vertexConsumerProvider, int light, ItemStack itemStack) {
        stack.push();

        stack.multiply(RotationAxis.NEGATIVE_Y.rotationDegrees(RotationComponent.getRotation(itemStack, delta + world.getTime())));
