...
public class CompatSwordItem extends SimplyMoreSwordItem {
    ...
    public CompatSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings, boolean grandsword , boolean lance, String... repairIngredient) {
