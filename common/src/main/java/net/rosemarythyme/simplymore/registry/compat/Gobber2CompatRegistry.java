...
public class Gobber2CompatRegistry {
    ...
    public static final RegistrySupplier<Item> GOBBER_GREAT_KATANA = ModItemsRegistry.ITEMS.register(
            "gobber_great_katana",
            () -> new CompatSwordItem(
    ...
    public static final RegistrySupplier<Item> GOBBER_GRANDSWORD = ModItemsRegistry.ITEMS.register(
            "gobber_grandsword",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_BACKHAND_BLADE = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_LANCE = ModItemsRegistry.ITEMS.register(
            "gobber_lance",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_KHOPESH = ModItemsRegistry.ITEMS.register(
            "gobber_khopesh",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_DAGGER = ModItemsRegistry.ITEMS.register(
            "gobber_dagger",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_PERNACH = ModItemsRegistry.ITEMS.register(
            "gobber_pernach",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_QUARTERSTAFF = ModItemsRegistry.ITEMS.register(
            "gobber_quarterstaff",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_GREAT_SPEAR = ModItemsRegistry.ITEMS.register(
            "gobber_great_spear",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_DEER_HORNS = ModItemsRegistry.ITEMS.register(
            "gobber_deer_horns",
            () -> new CompatSwordItem(
                    SimplyMoreToolMaterial.GOBBER,
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_GREAT_KATANA = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_GRANDSWORD = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_BACKHAND_BLADE = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_LANCE = ModItemsRegistry.ITEMS.register(
            "gobber_nether_lance",
            () -> new CompatNetherGobberSwordItem(
                    SimplyMoreToolMaterial.GOBBER_NETHER,
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_KHOPESH = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_DAGGER = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_PERNACH = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_QUARTERSTAFF = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_GREAT_SPEAR = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_NETHER_DEER_HORNS = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_GREAT_KATANA = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_GRANDSWORD = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_BACKHAND_BLADE = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_LANCE = ModItemsRegistry.ITEMS.register(
            "gobber_end_lance",
            () -> new CompatEndGobberSwordItem(
                    SimplyMoreToolMaterial.GOBBER_END,
    ...
    public static final RegistrySupplier<Item> GOBBER_END_KHOPESH = ModItemsRegistry.ITEMS.register(
            "gobber_end_khopesh",
            () -> new CompatEndGobberSwordItem(
                    SimplyMoreToolMaterial.GOBBER_END,
    ...
    public static final RegistrySupplier<Item> GOBBER_END_DAGGER = ModItemsRegistry.ITEMS.register(
            "gobber_end_dagger",
            () -> new CompatEndGobberSwordItem(
                    SimplyMoreToolMaterial.GOBBER_END,
    ...
    public static final RegistrySupplier<Item> GOBBER_END_PERNACH = ModItemsRegistry.ITEMS.register(
            "gobber_end_pernach",
            () -> new CompatEndGobberSwordItem(
                    SimplyMoreToolMaterial.GOBBER_END,
    ...
    public static final RegistrySupplier<Item> GOBBER_END_QUARTERSTAFF = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_GREAT_SPEAR = ModItemsRegistry.ITEMS.register(
    ...
    public static final RegistrySupplier<Item> GOBBER_END_DEER_HORNS = ModItemsRegistry.ITEMS.register(
    ...
    public static void addToGroup(List<Item> entries) {
        entries.add(GOBBER_GREAT_KATANA.get());
        entries.add(GOBBER_GRANDSWORD.get());
        entries.add(GOBBER_BACKHAND_BLADE.get());
        entries.add(GOBBER_LANCE.get());
        entries.add(GOBBER_KHOPESH.get());
        entries.add(GOBBER_DAGGER.get());
        entries.add(GOBBER_PERNACH.get());
        entries.add(GOBBER_QUARTERSTAFF.get());
        entries.add(GOBBER_GREAT_SPEAR.get());
        entries.add(GOBBER_DEER_HORNS.get());
        entries.add(GOBBER_NETHER_GREAT_KATANA.get());
        entries.add(GOBBER_NETHER_GRANDSWORD.get());
        entries.add(GOBBER_NETHER_BACKHAND_BLADE.get());
        entries.add(GOBBER_NETHER_LANCE.get());
        entries.add(GOBBER_NETHER_KHOPESH.get());
        entries.add(GOBBER_NETHER_DAGGER.get());
        entries.add(GOBBER_NETHER_PERNACH.get());
        entries.add(GOBBER_NETHER_QUARTERSTAFF.get());
        entries.add(GOBBER_NETHER_GREAT_SPEAR.get());
        entries.add(GOBBER_NETHER_DEER_HORNS.get());
        entries.add(GOBBER_END_GREAT_KATANA.get());
        entries.add(GOBBER_END_GRANDSWORD.get());
        entries.add(GOBBER_END_BACKHAND_BLADE.get());
        entries.add(GOBBER_END_LANCE.get());
        entries.add(GOBBER_END_KHOPESH.get());
        entries.add(GOBBER_END_DAGGER.get());
        entries.add(GOBBER_END_PERNACH.get());
        entries.add(GOBBER_END_QUARTERSTAFF.get());
        entries.add(GOBBER_END_GREAT_SPEAR.get());
        entries.add(GOBBER_END_DEER_HORNS.get());
    }
