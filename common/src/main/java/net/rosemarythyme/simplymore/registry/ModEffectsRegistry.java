...
public class ModEffectsRegistry {
    ...
    public static final RegistrySupplier<StatusEffect> SOUL_HEALTH = registerEffect(
            "soul_health",
            new ModStatusEffect(StatusEffectCategory.BENEFICIAL,7865862).addAttributeModifier(
    ...
    public static final RegistrySupplier<StatusEffect> MIMICRY /* Removed in SimplyMore v1.1.0 */ = registerEffect(
            "mimicry",
    ...
    public static final RegistrySupplier<StatusEffect> LANCE = registerEffect(
            ...
            new LanceEffect(StatusEffectCategory.NEUTRAL,0)
                    .addAttributeModifier(
                            ...
                            attributes.getLanceFriendshipDamageModifier(),
                            EntityAttributeModifier.Operation.ADDITION
                    )
    );
    ...
    public static final RegistrySupplier<StatusEffect> GROTESQUE /* Removed in SimplyMore v1.1.0 */ = registerEffect(
            "grotesque",
            new RemovedEffect(StatusEffectCategory.NEUTRAL,0)
    );
    ...
    public static RegistrySupplier<StatusEffect> registerEffect (String name, StatusEffect effect) {
        ...
        return EFFECTS.register(
                new Identifier(SimplyMore.ID, name),
                () -> effect
        );
    }
}
